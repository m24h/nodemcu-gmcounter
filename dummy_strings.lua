...
"tmr.create", "tmr.time", "tmr.now", "string.format", "u8g2.display", 
"alarm", "tmr.ALARM_AUTO", "tmr.ALARM_SINGLE", "tmr.delay", "wifi",
"bit.rshift", "bit.lshift", "bit.band", "bit.bor", 
"new", "\n", "\r\n", ":", " :", ": ", " : ","="," = ",
"font_5x7_tf","font_6x10_mf","font_7x13_mf", "font_10x20_mf",
"NULLMODE","RAM","STATION","_VERSION"
